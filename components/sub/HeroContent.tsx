    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        <motion.div
          ...
          className="Welcome-box lg:py-6 py-[8px] px-[7px] border border-[#7042f88b] opacity-[0.9]"
        >
        ...
        <motion.div
          ...
          className="md:text-4xl flex flex-col gap-6 mt-6 text-6xl font-bold text-white max-w-[600px] w-auto h-auto"
        >
          <span>
            Delivering
