...
const Footer = () => {
    return (
        <div className="w-full h-full mt-16 bg-transparent text-gray-200 shadow-lg p-[15px] z-[20]">
            <div className="w-full flex flex-col items-center  m-auto">
                <div className="w-full h-full sm:justify-start flex flex-row items-center justify-around flex-wrap mb-[180px]">
